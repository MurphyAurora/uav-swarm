...
EGO_LIKE_FRONTEND_MODE="${EGO_LIKE_FRONTEND_MODE:-local_astar}"
...
EGO_LIKE_ASTAR_INFLATION_RADIUS="${EGO_LIKE_ASTAR_INFLATION_RADIUS:-0.22}"
EGO_LIKE_ASTAR_LATCH_CLEARANCE="${EGO_LIKE_ASTAR_LATCH_CLEARANCE:-0.35}"
SAFE_PRIMITIVE_LATCH_SEC="${SAFE_PRIMITIVE_LATCH_SEC:-0.00}"
SAFE_PRIMITIVE_MAX_AGE_SEC="${SAFE_PRIMITIVE_MAX_AGE_SEC:-0.80}"
...
export SAFE_PRIMITIVE_LATCH_SEC
export SAFE_PRIMITIVE_MAX_AGE_SEC
...
echo "[INFO] safe_primitive max_age=${SAFE_PRIMITIVE_MAX_AGE_SEC}, latch=${SAFE_PRIMITIVE_LATCH_SEC}"
